...
{{< highlight text "linenos=table,hl_lines=3-5,linenostart=11" >}}
steps:
- name: backend
  environment:
    GOOS: linux
...
{{< highlight text "linenos=table,hl_lines=6-8,linenostart=11" >}}
steps:
- name: backend
  commands:
  - go build
...
{{< highlight text "linenos=table,hl_lines=5-8,linenostart=11" >}}
steps:
- name: cleanup
  commands:
...
{{< highlight text "linenos=table,hl_lines=3,linenostart=11" >}}
steps:
- name: backend
  failure: ignore
  commands:
